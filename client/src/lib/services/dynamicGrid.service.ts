 ...
 */
function joinVerticalGridTemplateAreas(gta: string[][], lrgta: string[][], rrgta: string[][]) {
...
function joinHorizontalGridTemplateAreas(gta: string[][], lrgta: string[][], rrgta: string[][]) {
	let leftNumRows = lrgta.length;
	let rightNumRows = rrgta.length;
